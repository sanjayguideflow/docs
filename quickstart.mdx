...
<div style={{ position:"relative",paddingBottom:"49.9%",height:0 }}> <iframe id="zklozwgfjk" src="https://app.guideflow.com/embed/zklozwgfjk" width="100%" height="100%" style={{ overflow:"hidden",position:"absolute",border:"none" }} scrolling="no" allow="clipboard-read; clipboard-write" webkitallowfullscreen="true" mozallowfullscreen="true" allowFullScreen />
</div>
